...
var AIR_ACCEL = 200.0
var AIR_DEACCEL = 0#200.0
var JUMP_VELOCITY = 460
var STOP_JUMP_FORCE = 0#900.0
...
func _integrate_forces(s):
	...
	# Get the controls
	var move_left = false#Input.is_action_pressed("move_left")
	var move_right = false#Input.is_action_pressed("move_right")
	var jump = false#Input.is_action_pressed("jump")
	var shoot = Input.is_action_pressed("shoot")
	var spawn = false#Input.is_action_pressed("spawn")
